          ...
          content: [
            {
              type: 'text',
              text: JSON.stringify(
                await graphqlService.getSchema(args as any),
                null,
                2
              ),
            },
          ...
          content: [
            {
              type: 'text',
              text: JSON.stringify(
                await graphqlService.filterQueries(args as any),
                null,
                2
              ),
            },
          ...
          content: [
            {
              type: 'text',
              text: JSON.stringify(
                await graphqlService.filterMutations(args as any),
                null,
                2
              ),
            },
          ...
          content: [
            {
              type: 'text',
              text: JSON.stringify(
                await graphqlService.filterTypes(args as any),
                null,
                2
              ),
            },
          ...
          content: [
            {
              type: 'text',
              text: JSON.stringify(
                await graphqlService.getTypeDetails(args as any),
                null,
                2
              ),
            },
          ...
          content: [
            {
              type: 'text',
              text: JSON.stringify(
                await graphqlService.getFieldDetails(args as any),
                null,
                2
              ),
            },
